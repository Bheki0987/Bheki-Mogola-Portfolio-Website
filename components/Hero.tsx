    ...
    <>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              View CV <Download size={18} className="group-hover:translate-y-1 transition-transform" />
            </button>
          </motion.div>
        </div>
      </section>
      ...
      {isResumeOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-neutral-900 border border-neutral-800 w-full max-w-5xl h-[90vh] flex flex-col shadow-2xl overflow-hidden relative">
            {/* Modal Header */}
            <div className="flex items-center justify-between p-4 border-b border-neutral-800 bg-neutral-900">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <Download className="rotate-45" size={20} /> {/* Used as Close Icon */}
                </button>
              </div>
            </div>
